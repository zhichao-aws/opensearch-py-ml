...
- Update model upload history -  sentence-transformers/all-MiniLM-L6-v2 (v.1.0.0)(BOTH) by @zhichao-aws ([#18](https://github.com/zhichao-aws/opensearch-py-ml/pull/18))
